        ...
        <article class="min-h-full p-5 bg-white rounded-lg flex flex-col">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <tbody>
                        <tr v-for="saleitem in saleitems" :key="saleitem.id">
                            <td class="px-6 py-4">Not yet done</td>
                            <td class="px-6 py-4">{{ saleitem.sale.salesDate }}</td>
                            <td class="px-6 py-4">Not yet done</td>
                            <td class="px-6 py-4">{{ saleitem.truckLoadItem }}</td>
                            <td class="px-6 py-4">{{ saleitem.quantity }}</td>
                            <td class="px-6 py-4">Not done</td>
                            <td class="px-6 py-4">{{ saleitem.sale.salesStatus }}</td>
